...
let totalSegundos = 0; 
let tempoInicial = 0;
// Guarda o tempo inicial para reinício automático 
let intervalo = null; 
let rodando = false; 
// Áudio de alerta 
const alertaSom = new Audio('the_third_sanctuary.mp3'); // Coloque alerta.mp3 na mesma pasta 
// Atualiza o display 
...
console.log('⏱ Display atualizado:', display.textContent); 
...
alert('⚠ Insira valores válidos: minutos >= 0 e segundos entre 0 e 59'); 
return; 
} 
